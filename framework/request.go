...
func (ctx *Context) QueryInt(key string, def int) (int, bool) {
	...
	if param, ok := params[key]; ok {
		if len(param) > 0 {
			return cast.ToInt(param[0]), true
		}
	}
	return def, false
}
...
func (ctx *Context) QueryInt64(key string, def int64) (int64, bool) {
	...
	if param, ok := params[key]; ok {
		if len(param) > 0 {
			return cast.ToInt64(param[0]), true
		}
	}
	return def, false
}
...
func (ctx *Context) QueryFloat64(key string, def float64) (float64, bool) {
	...
	if param, ok := params[key]; ok {
		if len(param) > 0 {
			return cast.ToFloat64(param[0]), true
		}
	}
	return def, false
}
...
func (ctx *Context) QueryFloat32(key string, def float32) (float32, bool) {
	...
	if param, ok := params[key]; ok {
		if len(param) > 0 {
			return cast.ToFloat32(param[0]), true
		}
	}
	return def, false
}
...
func (ctx *Context) QueryBool(key string, def bool) (bool, bool) {
	...
	if param, ok := params[key]; ok {
		if len(param) > 0 {
			return cast.ToBool(param[0]), true
		}
	}
	return def, false
}
